export function showTutorialPopup(toolbar) {
	...
	const rows = [
		...
		{ label: '1) Create Any Polyomino :', underline: true, icon: 'plus', description: 'Click this icon to open a menu. Select the polyomino you want to spawn it on the field. Drag and drop it onto the grid.' },
